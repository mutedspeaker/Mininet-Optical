set -e
url="localhost:8080";
t1=$url; t2=$url; t3=$url; t4=$url; t5=$url; t6=$url; t7=$url; t8=$url; t9=$url; t10=$url; t11=$url; t12=$url; t13=$url; t14=$url; t15=$url; 
...
$curl "$r2/connect?node=r2&port1=8&port2=8&channels=6"
$curl "$r2/connect?node=r2&port1=9&port2=9&channels=7"
$curl "$r2/connect?node=r2&port1=10&port2=10&channels=8"
$curl "$r2/connect?node=r2&port1=11&port2=11&channels=9"
$curl "$r3/connect?node=r3&port1=12&port2=12&channels=10"
$curl "$r3/connect?node=r3&port1=13&port2=13&channels=11"
$curl "$r3/connect?node=r3&port1=14&port2=14&channels=12"
$curl "$r3/connect?node=r3&port1=15&port2=15&channels=13"
$curl "$r3/connect?node=r3&port1=16&port2=16&channels=14"
$curl "$r3/connect?node=r3&port1=17&port2=17&channels=15"
