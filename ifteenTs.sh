...
$curl "$r2/connect?node=r2&port1=3&port2=3&channels=6"
$curl "$r3/connect?node=r3&port1=4&port2=4&channels=12"
$curl "$r4/connect?node=r4&port1=5&port2=5&channels=18"
$curl "$r5/connect?node=r5&port1=6&port2=6&channels=24"
$curl "$r1/connect?node=r1&port1=7&port2=7&channels=30"
$curl "$r2/connect?node=r2&port1=8&port2=8&channels=36"
$curl "$r3/connect?node=r3&port1=9&port2=9&channels=42"
$curl "$r4/connect?node=r4&port1=10&port2=10&channels=48"
$curl "$r5/connect?node=r5&port1=11&port2=11&channels=54"
$curl "$r1/connect?node=r1&port1=12&port2=12&channels=60"
$curl "$r2/connect?node=r2&port1=13&port2=13&channels=66"
$curl "$r3/connect?node=r3&port1=14&port2=14&channels=72"
$curl "$r4/connect?node=r4&port1=15&port2=15&channels=78"
$curl "$r5/connect?node=r5&port1=16&port2=16&channels=84"
