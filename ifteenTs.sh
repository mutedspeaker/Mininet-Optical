...
$curl "$t4/connect?node=t4&ethPort=6&wdmPort=5&channel=50"
$curl "$t5/connect?node=t5&ethPort=7&wdmPort=5&channel=51"
$curl "$t6/connect?node=t6&ethPort=3&wdmPort=7&channel=42"
$curl "$t7/connect?node=t7&ethPort=4&wdmPort=7&channel=43"
$curl "$t8/connect?node=t8&ethPort=5&wdmPort=7&channel=44"
$curl "$t9/connect?node=t9&ethPort=6&wdmPort=2&channel=52"
$curl "$t10/connect?node=t10&ethPort=7&wdmPort=2&channel=53"
$curl "$t11/connect?node=t11&ethPort=8&wdmPort=2&channel=54"
$curl "$t12/connect?node=t12&ethPort=9&wdmPort=2&channel=55"
$curl "$t13/connect?node=t13&ethPort=10&wdmPort=2&channel=56"
$curl "$t14/connect?node=t14&ethPort=11&wdmPort=2&channel=57"
$curl "$t15/connect?node=t15&ethPort=12&wdmPort=2&channel=58"
