...
echo "* Configuring terminals and ROADM nodes"

$curl "$t1/connect?node=t1&ethPort=1&wdmPort=2&channel=1"
$curl "$t2/connect?node=t2&ethPort=1&wdmPort=5&channel=1"
$curl "$t3/connect?node=t3&ethPort=1&wdmPort=2&channel=1"
$curl "$t4/connect?node=t4&ethPort=1&wdmPort=5&channel=1"
